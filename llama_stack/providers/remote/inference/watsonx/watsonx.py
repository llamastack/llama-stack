...
from llama_stack_spec.apis.models.models import ModelType
from llama_stack_spec.core.telemetry.tracing import get_current_span
...
class WatsonXInferenceAdapter(LiteLLMOpenAIMixin):
    ...
    async def openai_embeddings(
        ...
        from llama_stack_spec.apis.inference import OpenAIEmbeddingUsage
