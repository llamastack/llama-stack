...
class OpenAIMixin(NeedsRequestProviderData, ABC, BaseModel):
    ...
    async def openai_embeddings(
        ...
        """
<<<<<<< HEAD:llama_stack/providers/utils/inference/openai_mixin.py
...
=======
        ...
        request_params: dict[str, Any] = {
            "model": provider_model_id,
>>>>>>> d649c366 (fix: enforce allowed_models during inference requests (#4197)):src/llama_stack/providers/utils/inference/openai_mixin.py
            "input": params.input,
