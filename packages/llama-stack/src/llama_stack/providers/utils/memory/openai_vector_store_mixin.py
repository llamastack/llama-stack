...
if TYPE_CHECKING:
    from llama_stack_utils_vector_io.openai_vector_store_mixin import *  # noqa: F401, F403

import llama_stack_utils_vector_io.openai_vector_store_mixin as _canonical
