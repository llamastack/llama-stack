...
from llama_stack_utils_inference.openai_compat import get_stream_options_for_telemetry
from llama_stack_utils_inference.prompt_adapter import localize_image_content
...
from .utils import build_http_options as _build_http_options
