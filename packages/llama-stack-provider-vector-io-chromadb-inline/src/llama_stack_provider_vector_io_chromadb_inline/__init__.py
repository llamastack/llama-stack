...
from llama_stack_provider_vector_io_chromadb.inline_config import ChromaVectorIOConfig

from llama_stack_api import Api


async def get_provider_impl(config: ChromaVectorIOConfig, deps: dict[Api, Any]):
    from llama_stack_provider_vector_io_chromadb.chroma import ChromaVectorIOAdapter
