...
If you're new to Llama Stack, the [Getting Started guide](https://llamastack.github.io/docs/getting_started/) will walk you through setting up a server with your preferred inference provider. From there, the [OpenAI Implementation Guide](https://llamastack.github.io/docs/providers/openai) has examples of using the Responses API for everything from simple text generation to multi-tool agentic workflows.
