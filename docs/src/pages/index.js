...
const CLI_DEMOS = {
  claude: {
    ...
    lines: [
      ...
      { type: 'prompt', text: '> hello from ogx!', delay: 300 },
      { type: 'blank', text: '', delay: 400 },
      { type: 'result', text: 'Hello! I\'m running through OGX, powered by', delay: 0 },
      { type: 'result-cont', text: 'llama-3.3-70b. How can I help you today?', delay: 0 },
    ],
  },
  codex: {
    label: 'Codex',
    ...
    lines: [
      ...
      { type: 'prompt', text: '> hello from ogx!', delay: 300 },
      { type: 'blank', text: '', delay: 400 },
      { type: 'result', text: 'Hey there! I\'m running through OGX with', delay: 0 },
      { type: 'result-cont', text: 'llama-3.3-70b as the backend. What\'s up?', delay: 0 },
    ],
  },
};
