...
| `access_token` | `SecretStr \| None` | No |  | Optional access token for Vertex AI authentication. When set, this is used instead of Application Default Credentials (ADC). |
