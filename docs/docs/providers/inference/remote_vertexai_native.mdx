...
sidebar_label: Remote - Vertexai Native
title: remote::vertexai_native
---

# remote::vertexai_native

## Description

Google Vertex AI inference using native google-genai SDK. Supports thinking/reasoning config, context caching, response MIME type control, and other native Gemini features not available via OpenAI-compatible endpoint.
