...
Response branching, as discussed in the [Agents vs OpenAI Responses API documentation](https://ogx.github.io/docs/building_applications/responses_vs_agents), is not currently functional.
...
**Issue:** [#4381](https://github.com/ogx-ai/ogx/issues/4381)
