...
| Metric | Value |
|--------|-------|
| **Overall Conformance Score** | 91.0% |
| **Endpoints Implemented** | 29/146 |
| **Total Properties Checked** | 3441 |
| **Schema/Type Issues** | 199 |
| **Missing Properties** | 110 |
| **Total Issues to Fix** | 309 |
...
**Score:** 84.9% · **Issues:** 34 · **Missing:** 0
