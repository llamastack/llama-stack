...
| **Schema/Type Issues** | 276 |
| **Missing Properties** | 120 |
...
| `requestBody.content.application/json.properties.stream_options` | Union variants added: 1; Union variants removed: 1 |
