...
**Score:** 82.8% · **Issues:** 19 · **Missing:** 50
...
| `responses.200.content.text/event-stream.properties.choices.items.properties.finish_reason` | Enum removed: ['stop', 'length', 'tool_calls', 'content_filter', 'function_call']; Type removed: ['string']; Nullable added (OpenAI non-nullable); Union variants added: 2 |
