...
| Metric | Value |
|--------|-------|
| **Overall Conformance Score** | 32.1% |
| **Endpoints Implemented** | 30/117 |
| **Schema/Type Issues** | 252 |
| **Missing Properties** | 171 |
| **Total Issues to Fix** | 423 |
...
|----------|-------|--------|-------------------|
| Vector stores | 15.6% | 94 | 14 |
| Batch | 15.7% | 66 | 41 |
| Chat | 21.7% | 22 | 50 |
| Moderations | 31.2% | 5 | 39 |
| Conversations | 48.0% | 22 | 4 |
| Completions | 56.0% | 20 | 2 |
| Files | 62.0% | 11 | 8 |
| Responses | 80.0% | 2 | 8 |
| Embeddings | 84.0% | 8 | 0 |
| Models | 86.0% | 2 | 5 |
...
**Score:** 15.6% · **Issues:** 94 · **Missing:** 14
...
**Score:** 15.7% · **Issues:** 66 · **Missing:** 41
...
**Score:** 21.7% · **Issues:** 22 · **Missing:** 50
...
| Property | Issues |
|----------|--------|
| `responses.200.content.application/json.properties.data.items.properties.choices.items.properties.finish_reason` | Enum removed: ['stop', 'length', 'tool_calls', 'content_filter', 'function_call'] |
...
<details><summary>Schema Issues (11)</summary>

| Property | Issues |
|----------|--------|
| `responses.200.content.application/json.properties.choices.items.properties.finish_reason` | Enum removed: ['stop', 'length', 'tool_calls', 'content_filter', 'function_call'] |
...
| `responses.200.content.text/event-stream.properties.choices.items.properties.finish_reason` | Enum removed: ['stop', 'length', 'tool_calls', 'content_filter', 'function_call'] |
...
**Score:** 31.2% · **Issues:** 5 · **Missing:** 39
...
**Score:** 48.0% · **Issues:** 22 · **Missing:** 4
...
**Score:** 56.0% · **Issues:** 20 · **Missing:** 2
...
<details><summary>Schema Issues (20)</summary>
...
| `responses.200.content.application/json.properties.choices.items.properties.finish_reason` | Enum removed: ['stop', 'length', 'content_filter'] |
| `responses.200.content.application/json.properties.choices.items.properties.logprobs` | Union variants added: 1; Union variants removed: 1 |
...
**Score:** 62.0% · **Issues:** 11 · **Missing:** 8
...
- `parameters.query.include`
- `parameters.query.include_obfuscation`
- `parameters.query.starting_after`
- `parameters.query.stream`
...
<details><summary>Missing Properties (3)</summary>

- `responses.200.content.application/json.properties.first_id`
- `responses.200.content.application/json.properties.has_more`
- `responses.200.content.application/json.properties.last_id`
...
| Property | Issues |
|----------|--------|
| `responses.200.content.application/json.properties.data.items` | Union variants added: 4; Union variants removed: 20 |
| `responses.200.content.application/json.properties.object` | Type added: ['string']; Default changed: None -> list |
...
| Property | Issues |
|----------|--------|
| `requestBody.content.application/json.properties.dimensions` | Type removed: ['integer']; Nullable added (OpenAI non-nullable); Union variants added: 2 |
| `requestBody.content.application/json.properties.encoding_format` | Enum removed: ['float', 'base64']; Type removed: ['string']; Nullable added (OpenAI non-nullable); Union variants added: 2 |
| `requestBody.content.application/json.properties.input` | Union variants added: 2; Union variants removed: 4 |
| `requestBody.content.application/json.properties.model` | Type added: ['string']; Union variants removed: 2 |
| `requestBody.content.application/json.properties.user` | Type removed: ['string']; Nullable added (OpenAI non-nullable); Union variants added: 2 |
