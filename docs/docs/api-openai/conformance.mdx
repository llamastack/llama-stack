...
| Metric | Value |
|--------|-------|
| **Overall Conformance Score** | 86.6% |
| **Endpoints Implemented** | 29/146 |
| **Total Properties Checked** | 3441 |
| **Schema/Type Issues** | 328 |
| **Missing Properties** | 134 |
| **Total Issues to Fix** | 462 |

## Integration Test Coverage

**Overall Test Coverage Score: 43.2%**

| Category | Covered | Total | Score |
|----------|---------|-------|-------|
| CRUD Operations | 4 | 6 | 66.7% |
...
**Score:** 82.7% · **Issues:** 36 · **Missing:** 3
...
| `responses.200.content.application/json.properties.object` | Enum removed: ['response.compaction'] | No |
| `responses.200.content.application/json.properties.output.items` | Union variants added: 5 | Yes |
