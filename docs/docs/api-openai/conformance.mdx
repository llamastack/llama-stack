...
**Score:** 86.2% · **Issues:** 30 · **Missing:** 1
...
| `responses.200.content.application/json.properties.top_logprobs` | Type removed: ['integer']; Nullable added (OpenAI non-nullable); Union variants added: 2 | No |
