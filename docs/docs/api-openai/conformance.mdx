...
**Score:** 86.2% · **Issues:** 29 · **Missing:** 2
...
| `responses.200.content.application/json.properties.metadata` | Union variants added: 2 | No |
...
**Score:** 92.8% · **Issues:** 23 · **Missing:** 6
...
| Property | Issues | Tested |
|----------|--------|--------|
| `requestBody.content.application/json.properties.metadata` | Union variants added: 1; Union variants removed: 1 | No |
| `responses.200.content.application/json.properties.metadata` | Union variants added: 2 | No |
...
| Property | Issues | Tested |
|----------|--------|--------|
| `requestBody.content.application/json.properties.metadata` | Type added: ['object']; Nullable removed (OpenAI nullable); Union variants removed: 2 | No |
| `responses.200.content.application/json.properties.metadata` | Union variants added: 2 | No |
| `responses.200.content.application/json.properties.object` | Enum removed: ['conversation'] | No |
