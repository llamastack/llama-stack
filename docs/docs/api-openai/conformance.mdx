...
| Metric | Value |
|--------|-------|
| **Overall Conformance Score** | 88.1% |
| **Endpoints Implemented** | 28/146 |
| **Total Properties Checked** | 3441 |
| **Schema/Type Issues** | 289 |
| **Missing Properties** | 121 |
| **Total Issues to Fix** | 410 |
...
| Property | Issues |
|----------|--------|
| `responses.200.content.application/json.properties.owned_by` | Default changed: None -&gt; llama_stack |
