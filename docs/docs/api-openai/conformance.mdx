...
**Score:** 87.8% · **Issues:** 30 · **Missing:** 19
...
| `responses.200.content.application/json.properties.object` | Default changed: list -> None |
...
<details>
<summary>Schema Issues (16)</summary>
...
| `responses.200.content.text/event-stream.properties.choices.items.properties.delta.properties.tool_calls.items.properties.function` | Type removed: ['object'] |
...
| `responses.200.content.application/json.properties.metadata` | Union variants added: 2 | Yes |
| `responses.200.content.application/json.properties.object` | Default changed: conversation -> None | No |
