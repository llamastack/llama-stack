...
kubectl apply -f https://raw.githubusercontent.com/ogx/ogx-k8s-operator/main/release/operator.yaml

# Or install a specific version (e.g., v0.4.0)
# kubectl apply -f https://raw.githubusercontent.com/ogx/ogx-k8s-operator/v0.4.0/release/operator.yaml
```
