...
description: Open-source, OpenAI-compatible API server for building AI applications
sidebar_label: Intro
tags:
  - getting-started
  - overview
...
| **Vector Stores** | `/v1/vector_stores` | Managed document storage and semantic search |
...
The Responses API implementation conforms to the [Open Responses](https://www.openresponses.org/) specification. See the [API conformance report](./api-openai/conformance.mdx) for detailed coverage.
...
See the [provider documentation](./providers/index.mdx) for the full list and the [provider compatibility matrix](./api-openai/provider_matrix.md) for tested feature coverage across providers.
