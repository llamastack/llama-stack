...
Integration tests are located in [tests/integration](https://github.com/ogx-ai/ogx/tree/main/tests/integration). These tests use the python client-SDK APIs (from the `ogx_client` package) to test functionality by pointing to an instance of the OGX server.
