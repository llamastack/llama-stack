...
Llama Stack can act as a proxy server for [Codex CLI](https://github.com/vortex-labs/codex), enabling you to use your existing Codex workflows while leveraging Llama Stack's unified provider architecture and conversation compaction features.
...
For more information about Llama Stack's provider architecture, see [Providers Overview](/docs/providers). For Codex CLI documentation, visit the [Codex GitHub repository](https://github.com/vortex-labs/codex).
