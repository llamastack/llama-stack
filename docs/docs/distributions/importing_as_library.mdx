...
If you are planning to use an external service for Inference (even Ollama or vLLM counts as external), it is often easier to use Llama Stack as a library.
