...
| Integration Prompts Auth Tests | [integration-prompts-auth-tests.yml](integration-prompts-auth-tests.yml) | Run prompts tenant isolation tests with Kubernetes authentication |
