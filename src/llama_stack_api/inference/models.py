...
class OpenAIAssistantMessageParam(BaseModel):
    ...
    reasoning_content: str | None = Field(
        default=None, description="Reasoning content to preserve in multi-turn conversations with reasoning models."
    )
...
class OpenAIChatCompletionResponseMessage(BaseModel):
    ...
    reasoning_content: str | None = Field(
        default=None, description="Reasoning content from the model (for reasoning-capable models)."
    )
