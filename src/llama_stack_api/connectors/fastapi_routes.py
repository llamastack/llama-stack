...
def create_router(impl: Connectors) -> APIRouter:
    ...
    @router.get(
        ...
        responses={
            200: {"description": "A list of connector objects."},
        },
    )
    ...
    @router.get(
        ...
        responses={
            200: {"description": "The tool definition."},
        },
    )
    ...
    @router.get(
        ...
        responses={
            200: {"description": "A list of tool definitions."},
        },
    )
    ...
    @router.get(
        ...
        responses={
            200: {"description": "The connector object."},
        },
    )
