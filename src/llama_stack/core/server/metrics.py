...
meter = metrics.get_meter("llama_stack.server", version="1.0.0")
...
class RequestMetricsMiddleware:
    ...
    Metrics tracked:
    - llama_stack.requests_total: counter by api, method, status
    - llama_stack.request_duration_seconds: histogram by api, method
