...
class MLflowPromptsAdapter(Prompts):
    ...
    def __init__(self, config: MLflowPromptsConfig):
        ...
        """
        self.config = config
        self.mlflow_client: Any = None  # type: ignore[assignment]
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            logger.warning(f"Failed to set experiment '{self.config.experiment_name}': {e}")
