...
""",
        ...
        RemoteProviderSpec(
            api=Api.inference,
            adapter_type="llama-server",
            provider_type="remote::llama-server",
            pip_packages=[],
            module="llama_stack.providers.remote.inference.llama_server",
            config_class="llama_stack.providers.remote.inference.llama_server.config.LlamaServerConfig",
