...
def patch_httpx_for_test_id():
    ...
    _original_methods["ogx_client_prepare_request"] = LlamaStackClient._prepare_request
...
def unpatch_httpx_for_test_id():
    ...
    LlamaStackClient._prepare_request = _original_methods["ogx_client_prepare_request"]
