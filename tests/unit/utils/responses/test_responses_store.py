...
from llama_stack_spec.apis.inference import OpenAIMessageParam, OpenAIUserMessageParam
...
def create_test_response_input(content: str, input_id: str) -> OpenAIResponseInput:
    ...
    from llama_stack_spec.apis.agents.openai_responses import OpenAIResponseMessage
