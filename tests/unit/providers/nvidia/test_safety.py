...
import pytest
from llama_stack_spec.apis.inference import CompletionMessage, UserMessage
from llama_stack_spec.apis.resource import ResourceType
from llama_stack_spec.apis.safety import RunShieldResponse, ViolationLevel
from llama_stack_spec.apis.shields import Shield
from llama_stack_spec.models.llama.datatypes import StopReason
