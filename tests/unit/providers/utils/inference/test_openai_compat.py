...
import pytest
from llama_stack_spec.apis.common.content_types import TextContentItem
...
from llama_stack_spec.models.llama.datatypes import BuiltinTool, StopReason, ToolCall
