...
async def test_list_connectors_returns_empty_list():
    ...
    list_endpoint = _get_endpoint(router, "/v1/connectors", "GET")
...
async def test_get_connector_returns_connector():
    ...
    get_endpoint = _get_endpoint(router, "/v1/connectors/{connector_id}", "GET")
...
async def test_list_connector_tools_returns_tools():
    ...
    list_endpoint = _get_endpoint(router, "/v1/connectors/{connector_id}/tools", "GET")
...
async def test_get_connector_tool_returns_tool():
    ...
    get_endpoint = _get_endpoint(router, "/v1/connectors/{connector_id}/tools/{tool_name}", "GET")
...
def test_openapi_schema_has_connectors_endpoints():
    ...
    assert "/v1/connectors" in schema["paths"]
    assert "/v1/connectors/{connector_id}" in schema["paths"]
    assert "/v1/connectors/{connector_id}/tools" in schema["paths"]
    assert "/v1/connectors/{connector_id}/tools/{tool_name}" in schema["paths"]
...
def test_openapi_schema_list_connectors_is_get():
    ...
    schema = app.openapi()
    connectors_path = schema["paths"]["/v1/connectors"]
...
def test_openapi_schema_get_connector_has_path_param():
    ...
    schema = app.openapi()
    get_connector_path = schema["paths"]["/v1/connectors/{connector_id}"]
