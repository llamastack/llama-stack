...
class TestNeuralRerank:
    ...
    async def test_neural_rerank_uses_default_model_from_config(self):
        ...
        call_kwargs = store.inference_api.rerank.call_args
        assert call_kwargs.kwargs["model"] == "transformers/Qwen/Qwen3-Reranker-0.6B"
    ...
    async def test_neural_rerank_uses_model_from_params(self):
        ...
        call_kwargs = store.inference_api.rerank.call_args
        assert call_kwargs.kwargs["model"] == "custom/reranker-model"
    ...
    async def test_neural_rerank_respects_max_chunks_limit(self):
        ...
        call_kwargs = store.inference_api.rerank.call_args
        assert call_kwargs.kwargs["max_num_results"] == 2
