...
# - Uses web_search tool from ci-tests distribution
# - Gracefully skips tests when tools are unavailable (pytest.skip)
# - Library mode: Uses in-memory telemetry collector
# - Server mode: Not yet supported (collector startup timing issue)
