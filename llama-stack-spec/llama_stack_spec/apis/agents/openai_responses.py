...
from llama_stack_spec.apis.vector_io import SearchRankingOptions as FileSearchRankingOptions
from llama_stack_spec.schema_utils import json_schema_type, register_schema
